...
package OpenFIBS::Session::Command::beaver;
...
OpenFIBS::Session::Command::beaver - OpenFIBS Command `beaver'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::beaver->new (beaver => $session, $call);
