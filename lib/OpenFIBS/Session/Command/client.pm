...
package OpenFIBS::Session::Command::client;
...
OpenFIBS::Session::Command::client - OpenFIBS Command `client'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::client->new (client => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `client'.
