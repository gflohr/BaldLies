...
package OpenFIBS::Session::Command::shutdown;
...
OpenFIBS::Session::Command::shutdown - OpenFIBS Command `shutdown'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::shutdown->new (shutdown => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `shutdown'.
