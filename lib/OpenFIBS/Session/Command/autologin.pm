...
package OpenFIBS::Session::Command::autologin;
...
OpenFIBS::Session::Command::autologin - OpenFIBS Command `autologin'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::autologin->new (autologin => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `autologin'.
