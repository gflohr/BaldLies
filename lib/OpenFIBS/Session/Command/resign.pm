...
package OpenFIBS::Session::Command::resign;
...
OpenFIBS::Session::Command::resign - OpenFIBS Command `resign'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::resign->new (resign => $session, $call);
