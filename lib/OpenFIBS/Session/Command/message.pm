...
package OpenFIBS::Session::Command::message;
...
OpenFIBS::Session::Command::message - OpenFIBS Command `message'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::message->new (message => $session, $call);
