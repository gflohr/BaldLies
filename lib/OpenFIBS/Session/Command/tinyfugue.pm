...
package OpenFIBS::Session::Command::tinyfugue;
...
OpenFIBS::Session::Command::tinyfugue - OpenFIBS Command `tinyfugue'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::tinyfugue->new (tinyfugue => $session, $call);
