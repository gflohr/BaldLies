...
package OpenFIBS::Session::Command::stat;
...
OpenFIBS::Session::Command::stat - OpenFIBS Command `stat'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::stat->new (stat => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `stat'.
