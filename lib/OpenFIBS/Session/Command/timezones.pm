...
package OpenFIBS::Session::Command::timezones;
...
OpenFIBS::Session::Command::timezones - OpenFIBS Command `timezones'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::timezones->new (timezones => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `timezones'.
