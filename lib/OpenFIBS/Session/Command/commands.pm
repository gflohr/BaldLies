...
package OpenFIBS::Session::Command::commands;
...
OpenFIBS::Session::Command::commands - OpenFIBS Command `commands'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::commands->new (commands => $session, $call);
