...
package OpenFIBS::Session::Command::gag;
...
OpenFIBS::Session::Command::gag - OpenFIBS Command `gag'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::gag->new (gag => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `gag'.
