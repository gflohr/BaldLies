...
package OpenFIBS::Session::Command::invite;
...
OpenFIBS::Session::Command::invite - OpenFIBS Command `invite'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::invite->new (invite => $session, $call);
