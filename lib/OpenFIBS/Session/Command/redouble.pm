...
package OpenFIBS::Session::Command::redouble;
...
OpenFIBS::Session::Command::redouble - OpenFIBS Command `redouble'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::redouble->new (redouble => $session, $call);
