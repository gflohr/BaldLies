...
package OpenFIBS::Session::Command::reject;
...
OpenFIBS::Session::Command::reject - OpenFIBS Command `reject'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::reject->new (reject => $session, $call);
