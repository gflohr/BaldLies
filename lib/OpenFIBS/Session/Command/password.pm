...
package OpenFIBS::Session::Command::password;
...
OpenFIBS::Session::Command::password - OpenFIBS Command `password'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::password->new (password => $session, $call);
