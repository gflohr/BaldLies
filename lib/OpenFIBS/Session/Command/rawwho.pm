...
package OpenFIBS::Session::Command::rawwho;

use strict;

use base qw (OpenFIBS::Session::Command::who);
...
OpenFIBS::Session::Command::rawwho - OpenFIBS Command `rawwho'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::rawwho->new (rawwho => $session, $call);
