...
package OpenFIBS::Session::Command::oldboard;
...
OpenFIBS::Session::Command::oldboard - OpenFIBS Command `oldboard'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::oldboard->new (oldboard => $session, $call);
