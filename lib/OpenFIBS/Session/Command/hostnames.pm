...
package OpenFIBS::Session::Command::hostnames;
...
OpenFIBS::Session::Command::hostnames - OpenFIBS Command `hostnames'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::hostnames->new (hostnames => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `hostnames'.
