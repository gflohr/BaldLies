...
package OpenFIBS::Session::Command::double;
...
OpenFIBS::Session::Command::double - OpenFIBS Command `double'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::double->new (double => $session, $call);
