...
package OpenFIBS::Session::Command::rawboard;
...
OpenFIBS::Session::Command::rawboard - OpenFIBS Command `rawboard'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::rawboard->new (rawboard => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `rawboard'.
