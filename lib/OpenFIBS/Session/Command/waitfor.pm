...
package OpenFIBS::Session::Command::waitfor;
...
OpenFIBS::Session::Command::waitfor - OpenFIBS Command `waitfor'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::waitfor->new (waitfor => $session, $call);
