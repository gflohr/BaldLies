...
package OpenFIBS::Session::Command::raccoon;
...
OpenFIBS::Session::Command::raccoon - OpenFIBS Command `raccoon'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::raccoon->new (raccoon => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `raccoon'.
