...
package OpenFIBS::Session::Command::erase;
...
OpenFIBS::Session::Command::erase - OpenFIBS Command `erase'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::erase->new (erase => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `erase'.
