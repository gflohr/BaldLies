...
package OpenFIBS::Session::Command::rules;
...
OpenFIBS::Session::Command::rules - OpenFIBS Command `rules'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::rules->new (rules => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `rules'.
