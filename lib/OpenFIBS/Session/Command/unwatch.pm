...
package OpenFIBS::Session::Command::unwatch;
...
OpenFIBS::Session::Command::unwatch - OpenFIBS Command `unwatch'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::unwatch->new (unwatch => $session, $call);
