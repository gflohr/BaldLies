...
package OpenFIBS::Session::Command::whois;
...
OpenFIBS::Session::Command::whois - OpenFIBS Command `whois'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::whois->new (whois => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `whois'.
