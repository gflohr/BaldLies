...
package OpenFIBS::Session::Command::ratings;
...
OpenFIBS::Session::Command::ratings - OpenFIBS Command `ratings'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::ratings->new (ratings => $session, $call);
