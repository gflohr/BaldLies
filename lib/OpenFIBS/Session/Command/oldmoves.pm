...
package OpenFIBS::Session::Command::oldmoves;
...
OpenFIBS::Session::Command::oldmoves - OpenFIBS Command `oldmoves'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::oldmoves->new (oldmoves => $session, $call);
