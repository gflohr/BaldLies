...
package OpenFIBS::Session::Command::otter;
...
OpenFIBS::Session::Command::otter - OpenFIBS Command `otter'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::otter->new (otter => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `otter'.
