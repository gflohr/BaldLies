...
package OpenFIBS::Session::Command::dicetest;
...
OpenFIBS::Session::Command::dicetest - OpenFIBS Command `dicetest'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::dicetest->new (dicetest => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `dicetest'.
