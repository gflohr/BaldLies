...
package OpenFIBS::Session::Command::away;
...
OpenFIBS::Session::Command::away - OpenFIBS Command `away'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::away->new (away => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `away'.
