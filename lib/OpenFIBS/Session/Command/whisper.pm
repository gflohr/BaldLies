...
package OpenFIBS::Session::Command::whisper;
...
OpenFIBS::Session::Command::whisper - OpenFIBS Command `whisper'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::whisper->new (whisper => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `whisper'.
