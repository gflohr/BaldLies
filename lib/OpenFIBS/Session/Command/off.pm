...
package OpenFIBS::Session::Command::off;
...
OpenFIBS::Session::Command::off - OpenFIBS Command `off'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::off->new (off => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `off'.
