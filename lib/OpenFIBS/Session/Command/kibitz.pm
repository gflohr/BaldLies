...
package OpenFIBS::Session::Command::kibitz;
...
OpenFIBS::Session::Command::kibitz - OpenFIBS Command `kibitz'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::kibitz->new (kibitz => $session, $call);
