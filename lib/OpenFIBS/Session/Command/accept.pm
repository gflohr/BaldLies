...
package OpenFIBS::Session::Command::accept;
...
OpenFIBS::Session::Command::accept - OpenFIBS Command `accept'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::accept->new (accept => $session, $call);
