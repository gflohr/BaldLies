...
package OpenFIBS::Session::Command::boardstyle;
...
OpenFIBS::Session::Command::boardstyle - OpenFIBS Command `boardstyle'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::boardstyle->new (boardstyle => $session, $call);
