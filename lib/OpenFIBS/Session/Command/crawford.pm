...
package OpenFIBS::Session::Command::crawford;
...
OpenFIBS::Session::Command::crawford - OpenFIBS Command `crawford'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::crawford->new (crawford => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `crawford'.
