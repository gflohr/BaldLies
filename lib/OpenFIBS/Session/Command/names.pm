...
package OpenFIBS::Session::Command::names;
...
OpenFIBS::Session::Command::names - OpenFIBS Command `names'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::names->new (names => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `names'.
