...
package OpenFIBS::Session::Command::address;
...
OpenFIBS::Session::Command::address - OpenFIBS Command `address'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::address->new (address => $session, $call);
