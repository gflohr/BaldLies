...
package OpenFIBS::Session::Command::countries;
...
OpenFIBS::Session::Command::countries - OpenFIBS Command `countries'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::countries->new (countries => $session, $call);
