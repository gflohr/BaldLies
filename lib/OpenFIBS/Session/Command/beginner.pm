...
package OpenFIBS::Session::Command::beginner;
...
OpenFIBS::Session::Command::beginner - OpenFIBS Command `beginner'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::beginner->new (beginner => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `beginner'.
