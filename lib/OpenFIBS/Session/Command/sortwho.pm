...
package OpenFIBS::Session::Command::sortwho;
...
OpenFIBS::Session::Command::sortwho - OpenFIBS Command `sortwho'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::sortwho->new (sortwho => $session, $call);
