...
package OpenFIBS::Session::Command::formula;
...
OpenFIBS::Session::Command::formula - OpenFIBS Command `formula'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::formula->new (formula => $session, $call);
