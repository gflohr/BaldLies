...
package OpenFIBS::Session::Command::toggle;
...
OpenFIBS::Session::Command::toggle - OpenFIBS Command `toggle'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::toggle->new (toggle => $session, $call);
