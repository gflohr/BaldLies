...
package OpenFIBS::Session::Command::complaints;
...
OpenFIBS::Session::Command::complaints - OpenFIBS Command `complaints'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::complaints->new (complaints => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `complaints'.
