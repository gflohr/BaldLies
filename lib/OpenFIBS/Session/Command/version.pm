...
package OpenFIBS::Session::Command::version;
...
OpenFIBS::Session::Command::version - OpenFIBS Command `version'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::version->new (version => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `version'.
