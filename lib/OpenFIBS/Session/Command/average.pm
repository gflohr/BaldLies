...
package OpenFIBS::Session::Command::average;
...
OpenFIBS::Session::Command::average - OpenFIBS Command `average'

=head1 SYNOPSIS

  use OpenFIBS::Session::Command::average->new (average => $session, $call);
  
=head1 DESCRIPTION

This plug-in handles the ommand `average'.
