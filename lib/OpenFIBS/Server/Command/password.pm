...
package OpenFIBS::Server::Command::password;
...
OpenFIBS::Server::Command::password - OpenFIBS Command `password'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::password->new (password => $session, $call);
