...
package OpenFIBS::Server::Command::dicetest;
...
OpenFIBS::Server::Command::dicetest - OpenFIBS Command `dicetest'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::dicetest->new (dicetest => $session, $call);
