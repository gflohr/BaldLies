...
package OpenFIBS::Server::Command::timezones;
...
OpenFIBS::Server::Command::timezones - OpenFIBS Command `timezones'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::timezones->new (timezones => $session, $call);
