...
package OpenFIBS::Server::Command::boardstyle;
...
OpenFIBS::Server::Command::boardstyle - OpenFIBS Command `boardstyle'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::boardstyle->new (boardstyle => $session, $call);
