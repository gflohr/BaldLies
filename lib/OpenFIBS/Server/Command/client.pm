...
package OpenFIBS::Server::Command::client;
...
OpenFIBS::Server::Command::client - OpenFIBS Command `client'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::client->new (client => $session, $call);
