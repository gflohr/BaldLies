...
package OpenFIBS::Server::Command::hostnames;
...
OpenFIBS::Server::Command::hostnames - OpenFIBS Command `hostnames'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::hostnames->new (hostnames => $session, $call);
