...
package OpenFIBS::Server::Command::average;
...
OpenFIBS::Server::Command::average - OpenFIBS Command `average'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::average->new (average => $session, $call);
