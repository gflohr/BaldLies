...
package OpenFIBS::Server::Command::raccoon;
...
OpenFIBS::Server::Command::raccoon - OpenFIBS Command `raccoon'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::raccoon->new (raccoon => $session, $call);
