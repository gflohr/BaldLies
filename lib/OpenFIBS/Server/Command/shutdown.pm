...
package OpenFIBS::Server::Command::shutdown;
...
OpenFIBS::Server::Command::shutdown - OpenFIBS Command `shutdown'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::shutdown->new (shutdown => $session, $call);
