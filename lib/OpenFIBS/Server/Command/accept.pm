...
package OpenFIBS::Server::Command::accept;
...
OpenFIBS::Server::Command::accept - OpenFIBS Command `accept'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::accept->new (accept => $session, $call);
