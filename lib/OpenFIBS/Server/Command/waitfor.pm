...
package OpenFIBS::Server::Command::waitfor;
...
OpenFIBS::Server::Command::waitfor - OpenFIBS Command `waitfor'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::waitfor->new (waitfor => $session, $call);
