...
package OpenFIBS::Server::Command::oldboard;
...
OpenFIBS::Server::Command::oldboard - OpenFIBS Command `oldboard'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::oldboard->new (oldboard => $session, $call);
