...
package OpenFIBS::Server::Command::kibitz;
...
OpenFIBS::Server::Command::kibitz - OpenFIBS Command `kibitz'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::kibitz->new (kibitz => $session, $call);
