...
package OpenFIBS::Server::Command::toggle;
...
OpenFIBS::Server::Command::toggle - OpenFIBS Command `toggle'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::toggle->new (toggle => $session, $call);
