...
package OpenFIBS::Server::Command::formula;
...
OpenFIBS::Server::Command::formula - OpenFIBS Command `formula'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::formula->new (formula => $session, $call);
