...
package OpenFIBS::Server::Command::whisper;
...
OpenFIBS::Server::Command::whisper - OpenFIBS Command `whisper'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::whisper->new (whisper => $session, $call);
