...
package OpenFIBS::Server::Command::beginner;
...
OpenFIBS::Server::Command::beginner - OpenFIBS Command `beginner'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::beginner->new (beginner => $session, $call);
