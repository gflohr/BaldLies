...
package OpenFIBS::Server::Command::address;
...
OpenFIBS::Server::Command::address - OpenFIBS Command `address'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::address->new (address => $session, $call);
