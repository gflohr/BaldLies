...
package OpenFIBS::Server::Command::message;
...
OpenFIBS::Server::Command::message - OpenFIBS Command `message'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::message->new (message => $session, $call);
