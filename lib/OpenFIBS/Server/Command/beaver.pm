...
package OpenFIBS::Server::Command::beaver;
...
OpenFIBS::Server::Command::beaver - OpenFIBS Command `beaver'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::beaver->new (beaver => $session, $call);
