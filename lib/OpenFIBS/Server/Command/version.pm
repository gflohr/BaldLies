...
package OpenFIBS::Server::Command::version;
...
OpenFIBS::Server::Command::version - OpenFIBS Command `version'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::version->new (version => $session, $call);
