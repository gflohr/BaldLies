...
package OpenFIBS::Server::Command::tinyfugue;
...
OpenFIBS::Server::Command::tinyfugue - OpenFIBS Command `tinyfugue'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::tinyfugue->new (tinyfugue => $session, $call);
