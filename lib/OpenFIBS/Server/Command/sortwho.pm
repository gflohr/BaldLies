...
package OpenFIBS::Server::Command::sortwho;
...
OpenFIBS::Server::Command::sortwho - OpenFIBS Command `sortwho'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::sortwho->new (sortwho => $session, $call);
