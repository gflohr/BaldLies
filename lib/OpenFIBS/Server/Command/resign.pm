...
package OpenFIBS::Server::Command::resign;
...
OpenFIBS::Server::Command::resign - OpenFIBS Command `resign'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::resign->new (resign => $session, $call);
