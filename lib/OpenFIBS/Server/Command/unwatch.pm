...
package OpenFIBS::Server::Command::unwatch;
...
OpenFIBS::Server::Command::unwatch - OpenFIBS Command `unwatch'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::unwatch->new (unwatch => $session, $call);
