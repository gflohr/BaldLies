...
package OpenFIBS::Server::Command::rawboard;
...
OpenFIBS::Server::Command::rawboard - OpenFIBS Command `rawboard'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::rawboard->new (rawboard => $session, $call);
