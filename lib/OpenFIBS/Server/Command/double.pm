...
package OpenFIBS::Server::Command::double;
...
OpenFIBS::Server::Command::double - OpenFIBS Command `double'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::double->new (double => $session, $call);
