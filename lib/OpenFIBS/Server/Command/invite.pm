...
package OpenFIBS::Server::Command::invite;
...
OpenFIBS::Server::Command::invite - OpenFIBS Command `invite'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::invite->new (invite => $session, $call);
