...
package OpenFIBS::Server::Command::countries;
...
OpenFIBS::Server::Command::countries - OpenFIBS Command `countries'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::countries->new (countries => $session, $call);
