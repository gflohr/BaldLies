...
package OpenFIBS::Server::Command::oldmoves;
...
OpenFIBS::Server::Command::oldmoves - OpenFIBS Command `oldmoves'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::oldmoves->new (oldmoves => $session, $call);
