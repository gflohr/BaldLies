...
package OpenFIBS::Server::Command::commands;
...
OpenFIBS::Server::Command::commands - OpenFIBS Command `commands'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::commands->new (commands => $session, $call);
