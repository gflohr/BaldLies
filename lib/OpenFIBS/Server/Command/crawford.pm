...
package OpenFIBS::Server::Command::crawford;
...
OpenFIBS::Server::Command::crawford - OpenFIBS Command `crawford'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::crawford->new (crawford => $session, $call);
