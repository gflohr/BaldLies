...
package OpenFIBS::Server::Command::autologin;
...
OpenFIBS::Server::Command::autologin - OpenFIBS Command `autologin'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::autologin->new (autologin => $session, $call);
