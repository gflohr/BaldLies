...
package OpenFIBS::Server::Command::ratings;
...
OpenFIBS::Server::Command::ratings - OpenFIBS Command `ratings'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::ratings->new (ratings => $session, $call);
