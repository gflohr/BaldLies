...
package OpenFIBS::Server::Command::redouble;
...
OpenFIBS::Server::Command::redouble - OpenFIBS Command `redouble'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::redouble->new (redouble => $session, $call);
