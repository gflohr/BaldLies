...
package OpenFIBS::Server::Command::reject;
...
OpenFIBS::Server::Command::reject - OpenFIBS Command `reject'

=head1 SYNOPSIS

  use OpenFIBS::Server::Command::reject->new (reject => $session, $call);
