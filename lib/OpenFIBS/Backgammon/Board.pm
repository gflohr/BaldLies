...
package OpenFIBS::Backgammon::Board;
...
OpenFIBS::Backgammon::Board - Backgammon board representation
...
B<OpenFIBS::Backgammon::Board> is a dumb representation of the distribution
...
Applies B<MOVE> (see OpenFIBS::Backgammon::Move(3pm)) for B<COLOR> to the
...
Checks whether the the OpenFIBS::Backgammon::Move(3pm) is legal provided
...
OpenFIBS::Backgammon::Move(3pm), OpenFIBS::Const(3pm), perl(1)
