...
package OpenFIBS::Backgammon::Move;
...
OpenFIBS::Backgammon::Move - Backgammon move representation

=head1 SYNOPSIS

  use OpenFIBS::Backgammon::Move;

  my $move = OpenFIBS::Backgammon::Move->new (3, 1, 8, 5, 6, 5);

=head1 DESCRIPTION

B<OpenFIBS::Backgammon::Move> represents one backgammon move.
