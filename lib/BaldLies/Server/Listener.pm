...
package BaldLies::Server::Listener;
...
BaldLies::Server::Listener - BaldLies Listening Socket

=head1 SYNOPSIS

  use BaldLies::Server::Listener->new ($address_spec);
  
=head1 DESCRIPTION

B<BaldLies::Server::Listener> is an internal class.
