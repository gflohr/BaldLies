...
package BaldLies::Master::Command::check_name;
...
BaldLies::Master::Command::check_name - BaldLies Command `check_name'

=head1 SYNOPSIS

  use BaldLies::Master::Command::check_name->new ($master);
