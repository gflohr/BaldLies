...
BaldLies::Logger - BaldLies Logging Class

=head1 SYNOPSIS

  use BaldLies::Logger->new;
  
  BaldLies::Logger->new (level => LOG_INFO);

=head1 DESCRIPTION

B<BaldLies::Logger> formats and prints log messages.
...
BaldLies::Const (3pm), POSIX(3pm), BaldLies::Server(3pm), baldlies(1), perl(1)
