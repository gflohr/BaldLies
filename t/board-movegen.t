...
my $board = OpenFIBS::Backgammon::Board->new;
$board->init;
...
my $move = OpenFIBS::Backgammon::Move->new (3, 4, 24, 20, 13, 10);
ok $board->move ($move, WHITE);

$move = OpenFIBS::Backgammon::Move->new (3, 3, 19, 22, 19, 22, 17, 20, 17, 20);
ok $board->move ($move, BLACK);

# Illegal move: White dances.
$move = OpenFIBS::Backgammon::Move->new (3, 5, 13, 8, 13, 10);
ok !$board->move ($move, WHITE);
...
$move = OpenFIBS::Backgammon::Move->new (6, 4, 19, 25, 21, 25);
ok !$board->move ($move, BLACK);

# This is legal.
$move = OpenFIBS::Backgammon::Move->new (6, 4, 18, 22, 19, 25);
ok $board->move ($move, BLACK);

$move = OpenFIBS::Backgammon::Move->new (6, 6, 19, 25, 19, 25, 19, 25, 19, 25);
ok $board->move ($move, BLACK);

# Bear-off with waste.
$move = OpenFIBS::Backgammon::Move->new (6, 5, 21, 25, 21, 25);
ok $board->move ($move, BLACK);
...
$move = OpenFIBS::Backgammon::Move->new (4, 6, 23, 19);
ok !$board->move ($move, WHITE);
...
$move = OpenFIBS::Backgammon::Move->new (4, 6, 23, 17);
ok $board->move ($move, WHITE);
